...
function parseMessage(message: any) {
    ...
    let parsedMessage : {tags?:any, source?:any, command?:any, parameters?:any} = {  // Contains the component parts.
        tags: null,
        source: null,
        command: null,
        parameters: null
    ...
    parsedTags.forEach(tag => {
        ...
        switch (parsedTag[0]) {  // Switch on tag name
            ...
            case 'emote-sets':
                ...
                let emoteSetIds :any  = tagValue.split(',');  // Array of emote set IDs.
